...
class _SwipeState extends State<Swipe> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: FutureBuilder(
            future: swipeService.getProfilesToSwipe(
                Provider.of<ProfileState>(context, listen: false)
                    .getProfile()
                    .uid),
            builder: (ctx, snapshot) {
              if (snapshot.connectionState == ConnectionState.done) {
                          ...
                          children: [
                            ElevatedButton(
                              ...
                              style: ElevatedButton.styleFrom(
                                backgroundColor:
                                    Colors.red, // Set button color here
                              ),
                              child: const Text(
                                "Nope",
                                style: TextStyle(
                            ...
                            ElevatedButton(
                                ...
                                style: ElevatedButton.styleFrom(
                                  backgroundColor:
                                      Colors.lightBlue, // Set button color here
                                ),
                                child: const Text(
                                  "Super Like",
                                  style: TextStyle(
                            ...
                            ElevatedButton(
                                ...
                                style: ElevatedButton.styleFrom(
                                  backgroundColor:
                                      Colors.green, // Set button color here
                                ),
                                child: const Text(
                                  "Like",
                                  style: TextStyle(
                ...
                return const Center(
                  child: Text("Der er sket en fejl.."),
                );
              }
            }));
  }
